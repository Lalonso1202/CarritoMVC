...
namespace CarritoMVC.Controllers
{
    public class ComprasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCompra,IdCarrito,Total")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCompra,IdCarrito,Total")] Compra compra)
        {
